...
function sortCarInventory(inventory) {
  /* code here */
  let sortInventory = function (firstElement, secondElement) {
    if (firstElement.car_model > secondElement.car_model){
      return 1;
    }
    else return -1;
  }
...
*/
function getOlderCars(inventory, yearsMax) {
  /* code here */
  let cars = [];
  for (let i = 0; i < inventory.length; i++){
    if (inventory[i].car_year <= yearsMax) {
